  ...
  return (
    <div className="empty-state">
      ...
      <p className="empty-state-text">
        Try a different keyword — city, country, or category.
      </p>
      <button className="btn btn-warm-sand" onClick={onClear}>
        Clear search
      </button>
    </div>
  );
        ...
        <div className="container">
          <div className="footer-inner">
            <p className="footer-text">
              Wander List · {locations.length} destinations ·{" "}
              {locations.filter((l) => l.status === "visited").length} explored
            </p>
            <p
              className="footer-text"
              style={{ color: "var(--color-border-warm)" }}
            >
